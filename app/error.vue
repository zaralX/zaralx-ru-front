...
<template>
<div class="fixed bg-bg-main-light dark:bg-bg-main-dark w-screen h-screen flex justify-center items-center text-black font-fira dark:text-white min-h-screen">
  <div>
    <h1>404</h1>
