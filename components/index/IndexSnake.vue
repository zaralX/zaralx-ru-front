...
const snakeBest = useCookie("snake-best")
const snakeLast = useCookie("snake-last")
...
const best = ref(snakeBest.value ?? 0);
if (!snakeLast.value) {
  snakeLast.value = "0"
}
const last = ref(snakeLast.value ?? 0);
const lastBest = ref(snakeBest.value ?? 0);
