...
<template>
  <button :disabled="props.disabled" @click="openTelegramAuth" class="bg-blue-600 disabled:opacity-75 enabled:hover:bg-blue-700 transition-all duration-100 py-2 rounded-lg w-full flex justify-start items-center px-3">
