...
<template>
  <div class="w-full rounded-lg bg-neutral-900 group shadow-lg hover:scale-[1.02] duration-500">
    <div class="w-full h-full rounded-lg bg-gradient-to-tr from-neutral-700/20 to-neutral-800/40 p-[3px]">
